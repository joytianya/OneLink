...
--> statement-breakpoint
CREATE TABLE "redeem_risk_attempts" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"ip_hash" text,
	"email_hash" text,
...
CREATE INDEX "idx_admin_audit_logs_created_at" ON "admin_audit_logs" USING btree ("created_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "idx_redeem_risk_attempts_ip_hash" ON "redeem_risk_attempts" USING btree ("ip_hash");--> statement-breakpoint
CREATE INDEX "idx_redeem_risk_attempts_email_hash" ON "redeem_risk_attempts" USING btree ("email_hash");--> statement-breakpoint
CREATE INDEX "idx_redeem_risk_attempts_created_at" ON "redeem_risk_attempts" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_redeem_risk_attempts_outcome" ON "redeem_risk_attempts" USING btree ("outcome");